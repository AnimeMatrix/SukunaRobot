    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*Hi again! The name's {dispatcher.bot.first_name}. \n\nI'm An Anime Themed Group Management Bot.* "
                 ...
                 f"\n\n I have the normal Group Mananging functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
        ...
        query.message.edit_text(
            text=f"* ｢ BASIC HELP 」*"
                 f"\n\nYou can read *Basic Configuration Checklist* by clicking [Here](https://telegra.ph/SUZUYA-GM-BOT-12-16).\n"
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton(text="Admin settings", callback_data="aboutmanu_permis"),
                InlineKeyboardButton(text="Antispam", callback_data="aboutmanu_spamprot")],
                [
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} is a powerful bot for managing groups with additional features.*"
                 f"\n\nBase of [Shoko](https://github.com/gizmostuffin/Shoko) + [Saitama](https://github.com/AnimeKaizoku/SaitamaRobot)."
                 f"\n\n{dispatcher.bot.first_name}'s Licensed Under The GNU _(General Public License v3.0)_"
                 f"\n\nIf you have any question about {dispatcher.bot.first_name}, \nReach us at @{SUPPORT_CHAT}.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        ...
        query.message.edit_text(
            text=f"<b> ｢ Admin Permissions 」</b>"
                 ...
                 f"\n\nIf you want to update them immediately, you can use the /admincache command, that'll force {dispatcher.bot.first_name} to check who the admins are again and their permissions"
                 ...
                 f"\n\nThe message very clearly states that you need these rights - <i>not {dispatcher.bot.first_name}.</i>",
            parse_mode=ParseMode.HTML,
        ...
        query.message.edit_text(
            text=f"<b> ｢ Terms and Conditions 」</b>\n"
                 ...
                 f"\n✪ Make sure antiflood is enabled, so that users cannot flood/spam your group."
                 f"\n✪ Do not spam commands, buttons, or anything in bot PM, else you will  be <b>Gbanned</b>."
                 f"\n✪ If you need to ask anything about this bot or you need help, reach us at @{SUPPORT_CHAT}."
                 f"\n✪ If you are asking nonsense in Support Chat, you will be warned/banned."
                 f"\n✪ Sharing any files/videos not related to Suzuya in Support Chat is prohibited."
