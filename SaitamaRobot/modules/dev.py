...
def allow_groups(update: Update, context: CallbackContext):
    ...
    if args[0].lower() in ["off", "no"]:
        ...
        update.effective_message.reply_text("Format: /allowgc Yes/No or Off/On")
        return
    update.effective_message.reply_text("Done! Allow GroupChat value toggled.")
...
ALLOWGROUPS_HANDLER = CommandHandler("allowgc", allow_groups)
